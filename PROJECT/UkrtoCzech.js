d3.csv("./Dataset/UkrtoCzech.csv").then(function(data) {
   ...
   selection
    ...
    svg7.selectAll(".dot")
        ...
        .on("mouseover", function(event, d) {
            ...
            let [x, y] = d3.pointer(event, svg7.node());
            
            tooltip4.transition()
                .duration(200)
                .style("opacity", .9);
            tooltip4.html(`<strong>Year:</strong> ${d.Years}<br/><strong>Count:</strong> ${d.Count}`)
                .style("left", `${x + 265}px`)
                .style("top", `${y + 100}px`);
        })
    ...
    svg7.append("text")
        ...
        .text("Ukraine migrate to Czech from 2010 to 2023");
