d3.csv("./Dataset/UkrtoRus.csv").then(function(data) {
   ...
   selection
    ...
    svg6.selectAll(".dot")
        ...
        .on("mouseover", function(event, d) {
            ...
            let [x, y] = d3.pointer(event, svg6.node());
            
            tooltip3.transition()
                .duration(200)
                .style("opacity", .9);
            tooltip3.html(`<strong>Year:</strong> ${d.Years}<br/><strong>Count:</strong> ${d.Count}`)
                .style("left", `${x + 265}px`)
                .style("top", `${y + 100}px`);
        })
    ...
    svg6.append("text")
        ...
        .text("Ukraine migrate to Russia from 2010 to 2023");
